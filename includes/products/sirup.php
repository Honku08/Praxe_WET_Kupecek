<a href="" class="product--card" data-type="sirup"
    ...
    <div class="product--content">    
        ...
        <p>Sirup s echinaceou a medem pro podporu imunity.</p>
    </div>
    <form class="add-to-cart-form" method="post">
        <input type="hidden" name="product_id" value="4">
        <input type="hidden" name="product_name" value="Immuno Syrup">
...
<a href="" class="product--card" data-type="sirup"
    ...
    <div class="product--content">    
        ...
        <p class="price">150 Kč</p>
        <p>Rychlá dávka energie z guarany a ženšenu.</p>
    </div>
    <form class="add-to-cart-form" method="post">
        <input type="hidden" name="product_id" value="5">
        <input type="hidden" name="product_name" value="Energy Shot Syrup">
        <input type="hidden" name="product_price" value="150">
        <input type="hidden" name="product_image" value="images/testneco.jpg">
        <input type="hidden" name="product_filter" value="sirup">
        <button type="submit" name="add_to_cart">Přidat do košíku</button>
...
<a href="" class="product--card" data-type="sirup"
    ...
    <div class="product--content">    
        ...
        <p class="price">150 Kč</p>
        <p>Zklidni tělo i mysl před spánkem.</p>
    </div>
    <form class="add-to-cart-form" method="post">
        <input type="hidden" name="product_id" value="6">
        <input type="hidden" name="product_name" value="Sleep Relax Syrup">
        <input type="hidden" name="product_price" value="150">
        <input type="hidden" name="product_image" value="images/testneco.jpg">
        <input type="hidden" name="product_filter" value="sirup">
        <button type="submit" name="add_to_cart">Přidat do košíku</button>

<div class="product--card product" data-type="detox"
    ...
    <div class="product--content">    
        ...
        <p class="price">129,90 Kč</p>
        <p>Podpora jater a přirozené detoxikace těla.</p>
    </div>
    <form class="add-to-cart-form" method="post">
        <input type="hidden" name="product_id" value="13">
        <input type="hidden" name="product_name" value="Liver Cleanse Complex">
        <input type="hidden" name="product_price" value="129.90">
        <input type="hidden" name="product_image" value="images/products/LiverCleanseComplex-nobg.png">
...
<div class="product--card product" data-type="detox"
    ...
    <div class="product--content">    
        ...
        <p class="price">139,90 Kč</p>
        <p>Bylinná směs pro očistu těla a podporu trávení.</p>
    </div>
    <form class="add-to-cart-form" method="post">
        <input type="hidden" name="product_id" value="14">
        <input type="hidden" name="product_name" value="Detox Tea Balance">
        <input type="hidden" name="product_price" value="139.90">
        <input type="hidden" name="product_image" value="images/products/DetoxTeaBalance-nobg.png">
        <input type="hidden" name="product_filter" value="detox">
        <button type="submit" name="add_to_cart">Přidat do košíku</button>
    </form>
</div>
...
<div class="product--card product" data-type="detox"
    ...
    <div class="product--content">    
        ...
        <p class="price">109,90 Kč</p>
        <p>Třídenní kúra pro restart organismu.</p>
    </div>
    <form class="add-to-cart-form" method="post">
        <input type="hidden" name="product_id" value="15">
        <input type="hidden" name="product_name" value="Pure Body Reset">
        <input type="hidden" name="product_price" value="109.90">
        <input type="hidden" name="product_image" value="images/products/PureBodyReset-nobg.png">
        <input type="hidden" name="product_filter" value="detox">
        <button type="submit" name="add_to_cart">Přidat do košíku</button>
    </form>
</div>